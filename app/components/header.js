    ...
    <div id="header" className="header-container">
      ...
      >
        ...
        <div className="rotating-skills-container flex items-center justify-center">
          ...
          <RotatingText
            texts={['React', 'MongoDB', 'Javascript', 'Typescript', 'Node.js', 'Next.js', 'RESTful API', 'Tailwind CSS', 'HTML', 'CSS', 'Python', 'Svelte', 'PostgreSQL', 'Photoshop', 'Figma', 'Git', '.NET', 'C#', 'jQuery', 'Java', 'MySQL', 'Microsoft SQL', 'PHP', 'Web Servers', 'WebSockets', 'Docker', 'Kubernetes', 'Lua', 'Linux', 'Apache', 'RabbitMQ', 'Unity', 'Arduino', 'Copywriting', 'Graphic Design', 'Video Editing', 'Vue', 'Bootstrap', 'Kafka', 'Micro Services', 'Nginx', 'Jenkins', 'Unreal Engine', 'Blender']}
